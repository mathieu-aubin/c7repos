...
_importGPGKEYS() {
  ...
  rpm --import https://raw.githubusercontent.com/wp-cli/builds/gh-pages/wp-cli.pgp ; sleep 0.02 ;
...
_installREPOS() {
  ...
  echo -e "\033[1mCreating repository files (.repo) for repositories without install packages...\033[0m " ;
	...
	[nginx-source]
	name=NGiNX stable source repository for CentOS \$releasever
  ...
  # Yarn
  echo -e "\033[1mInstalling Yarn repository from official source...\033[0m" ; sleep 0.2 ;
